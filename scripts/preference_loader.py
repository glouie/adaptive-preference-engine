...
from scripts.models import Association, ContextStack
...
class PreferenceLoader:
    ...
    def load_for_context(self, 
                        ...
                        stack_contexts: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        ...
        if primary_pref:
            loaded["primary"] = {
                ...
                "preferences": self._load_preference_tree(primary_pref_id)
            }
                ...
                if next_confidence >= self.confidence_threshold:
                    ...
                    if next_pref:
                        loaded["associated"].append({
                            ...
                            "preferences": self._load_preference_tree(next_id)
                        })
...
if __name__ == "__main__":
    # Quick test
    from scripts.models import Preference, Association, ContextStack, generate_id
